  ...
  return (
    <MantineProvider theme={theme}>
      ...
      <Head>
        ...
        <meta property="og:title" content="Tourhjelper - TV 2 Tourmanager Tips" />
        <meta 
          property="og:description" 
          content="Verktøyet som hjelper deg å velge riktige ryttere og knuse vennegjengen i TV 2 Tourmanager." 
        />
        {/* Hvis du har en logo/skjermbilde i public-mappen din, f.eks. public/og-image.png */}
        <meta property="og:image" content="https://tourhjelper.no/og-image.png" /> 

        {/* Twitter / X */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://tourhjelper.no" />
        <meta property="twitter:title" content="Tourhjelper - TV 2 Tourmanager Tips" />
        <meta 
          property="twitter:description" 
          content="Verktøyet som hjelper deg å velge riktige ryttere og knuse vennegjengen i TV 2 Tourmanager." 
        />
        <meta property="twitter:image" content="https://tourhjelper.no/og-image.png" />
      </Head>
      <Component {...pageProps} />
    </MantineProvider>
  );
